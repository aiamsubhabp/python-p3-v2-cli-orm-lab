...
def find_employee_by_id():
    id_ = input('Please enter the employee id: ')
...
def list_department_employees():
    ...
    if department:
        ...
        if employees:
            ...
            print(f"No employees found in Department {department.name}.")
    else:
        print(f"Department with ID {department_id} not found in the database.")